...
//                                         className="w-32 h-32 flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden hover:opacity-80 transition-opacity"
//                                     >
...
//                                             <h3 className="text-lg font-bold text-gray-800 mb-2 hover:text-primary transition-colors cursor-pointer">
...
//             <h2 className="text-2xl font-bold text-gray-800 mb-6">내가 신고한 내역</h2>
//             <div className="space-y-4">
...
//                                 count: unreadCount,
//                             },
//                             // 🎯🔥✨💫⭐🌟🎊 USER 전용 신고 내역 탭 추가 (Admin 제외) 🎊🌟⭐💫✨🔥🎯
//                             ...(user?.role !== "ADMIN"
//                                 ? [{ name: "reports", icon: "bi-flag", label: "신고 내역" }]
//                                 : []),
//                         ].map((tab) => (
//                             <button
//                                 key={tab.name}
...
const MyPage = () => {
    ...
    // 🎯🔥✨💫⭐🌟 [추가 4 시작] USER 전용 신고 내역 로드 (Admin 제외) 🌟⭐💫✨🔥🎯
    useEffect(() => {
        if (isAuthenticated && user && user.role !== "ADMIN") {
            fetchReports();
        }
                ...
                <div className="bg-white rounded-t-2xl shadow-lg">
                    <div className="flex border-b border-gray-200">
                        {[
                            ...
                            // 🎯🔥✨💫⭐🌟🎊 [추가 6 시작] USER 전용 신고 내역 탭 (Admin 제외) 🎊🌟⭐💫✨🔥🎯
                            ...(user?.role !== "ADMIN"
                                ? [{ name: "reports", icon: "bi-flag", label: "신고 내역" }]
                                : []),
                            // 🎯🔥✨💫⭐🌟🎊 [추가 6 끝] 🎊🌟⭐💫✨🔥🎯
