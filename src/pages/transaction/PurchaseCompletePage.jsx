    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.log("purchase complete payload:", payload);

                if (!payload || payload.success === false || !payload.data) {
                    throw new Error(payload?.message || "거래 정보를 불러올 수 없습니다.");
                }
                        ...
                        <div className="flex">
                            ...
                            <div className="text-sm text-yellow-800">
                                ...
                                <ul className="list-disc list-inside space-y-1">
                                    <li>입금 기한 내에 입금하지 않으면 주문이 자동 취소될 수 있습니다.</li>
                                    <li>입금자명이 다른 경우 마이페이지에서 입금자명을 수정해주세요.</li>
